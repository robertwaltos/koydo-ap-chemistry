...
export const metadata: Metadata = {
  title: "Pricing — Ap Chemistry Premium",
  description: "Unlock unlimited Ap Chemistry practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=ap-chemistry&cadence=annual`;
